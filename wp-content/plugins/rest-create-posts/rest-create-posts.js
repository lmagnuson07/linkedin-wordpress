    ...
    $('.rest-create-post').on('submit', function(event) {
        ...
        $.ajax({
            ...
            beforeSend: function(xhr, settings) {
                ...
                // in order to make post requests via the rest api, you must include a header named X-WP-Nonce
                // defined as an inline javascript object which we add with our enqueue function wp_create_nonce
