...
if ( is_singular( 'post' ) && get_theme_mod( 'web_blog_enable_related_post_section', true ) ) {
	...
	if ( $query->have_posts() ) :
		$related_title = get_theme_mod( 'web_blog_related_posts_title', __( 'Related Posts', 'web-blog' ) );
		?>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						<div class="post-item post-grid">
							<div class="post-item-image">
								<a href="<?php the_permalink(); ?>"><?php web_blog_post_thumbnail(); ?></a>
							</div>
