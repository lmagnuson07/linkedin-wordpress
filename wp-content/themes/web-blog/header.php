...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#primary-content"><?php esc_html_e( 'Skip to content', 'web-blog' ); ?></a>
		<div id="loader">
				...
				<div class="theme-wrapper">
					<div class="adore-header-title-wrapper">
						<div class="site-branding">
							...
							if ( get_theme_mod( 'web_blog_header_text_display', true ) === true ) {
								?>
