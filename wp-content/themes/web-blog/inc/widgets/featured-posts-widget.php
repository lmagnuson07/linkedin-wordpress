<?php
if ( ! class_exists( 'Web_Blog_Featured_Posts_Widget' ) ) {
	/**
	 * Adds Web Blog Featured Posts Widget.
	 */
	class Web_Blog_Featured_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$featured_posts_widget = array(
				...
				'description' => __( 'Retrive Posts List Widgets', 'web-blog' ),
			);
			parent::__construct(
				'web_blog_featured_posts_widget',
				__( 'Web Blog: Featured Posts Widget', 'web-blog' ),
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'web-blog' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'web-blog' ); ?></label>
				<select id="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'category' ) ); ?>" class="widefat" style="width:100%;">
					<?php
					$categories = web_blog_get_post_cat_choices();
