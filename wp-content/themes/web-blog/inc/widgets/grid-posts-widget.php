<?php
if ( ! class_exists( 'Web_Blog_Grid_Posts_Widget' ) ) {
	/**
	 * Adds Web Blog Grid Posts Widget.
	 */
	class Web_Blog_Grid_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'web_blog_grid_posts_widget',
				__( 'Web Blog: Grid Posts Widget', 'web-blog' ),
				$grid_posts_widget
			);
		}
